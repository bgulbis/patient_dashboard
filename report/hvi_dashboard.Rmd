...
colDefs1 <- list(
    ...
    list(targets = i + 1, width = '55px', render = JS("function(data, type, full){ return '<span class=spark_scr>' + data + '</span>' }")),
    list(targets = i + 2, width = '55px', render = JS("function(data, type, full){ return '<span class=spark_hgb>' + data + '</span>' }")),
    list(targets = i + 3, width = '55px', render = JS("function(data, type, full){ return '<span class=spark_plt>' + data + '</span>' }")),
    list(targets = i + 4, width = '55px', render = JS("function(data, type, full){ return '<span class=spark_wbc>' + data + '</span>' }")),
    list(targets = i + 5, width = '55px', render = JS("function(data, type, full){ return '<span class=spark_sbp>' + data + '</span>' }")),
    list(targets = i + 6, width = '55px', render = JS("function(data, type, full){ return '<span class=spark_hr>' + data + '</span>' }")),
    list(targets = i + 7, width = '55px', render = JS("function(data, type, full){ return '<span class=spark_gluc>' + data + '</span>' }")),
    list(targets = i + 10, width = '55px', render = JS("function(data, type, full){ return '<span class=spark_uop>' + data + '</span>' }"))
...
col_names <- c("Patient", "Age", "Sex", "LOS", "SOFA", "Tmax", "SCr", "Hgb", "Plt", "WBC", "SBP", "HR", "Gluc", "SSI", "UOP", "Hourly", "Drips", "Alerts", "PCA", "Doses")
```
