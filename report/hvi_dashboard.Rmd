...
colDefs1 <- list(
    ...
    list(targets = i + 7, width = '60px', render = JS("function(data, type, full){ return '<span class=spark_gluc>' + data + '</span>' }")),
...
col_names <- c("Patient", "Age", "Sex", "LOS", "SOFA", "Tmax", "SCr", "Hgb", "Plt", "WBC", "SBP", "HR", "Gluc", "SSI", "UOP", "Drips", "Alerts")
```
